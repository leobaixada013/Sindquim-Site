...
function sindicato_enqueue_assets() {
    wp_enqueue_style( 'sindicato-main', get_template_directory_uri() . '/assets/css/main.css', array(), '0.2.0' );
    wp_enqueue_script( 'sindicato-main', get_template_directory_uri() . '/assets/js/main.js', array(), '0.2.0', true );
}
